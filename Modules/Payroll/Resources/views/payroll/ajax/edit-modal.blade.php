                            ...
                            <table width="100%">
                                ...
                                @if($key != 'Total Hours')
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:;"
                                               class="d-flex align-items-center 0 remove-item"><i
    ...
    $(document).ready(function () {
        ...
        $('#add-earning').click(function () {
            var earning = '<tr>' +
                ...
                '<td><input type="number" min="0" value="0" step=".01" class="form-control text-right height-35 f-14 my-2" name="extra_earnings[]"></td>' +
        ...
        $('body').on('click', '.remove-item', function (e) {
            ...
            calculateNetSalary(e.target.id);
        });

        $('body').on('keyup', "input[name='earnings[]'], input[name='deductions[]'], input[name='extra_earnings[]'],  input[name='extra_deductions[]'],  #basic-salary, #expense_claims, #fixed" , function (e) {
            calculateNetSalary(e.target.id);
        });

        function calculateNetSalary(elementID) {

            let grossEarning = $('#basic-salary').val();
            let grossSalary = "{{ $salarySlip->gross_salary }}";
            ...
            console.log(netSalary, grossEarning, totalDeductions, reimbursement);
