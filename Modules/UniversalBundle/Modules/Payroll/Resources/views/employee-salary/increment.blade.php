...
<div class="modal-body">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                <x-forms.label :fieldLabel="__('payroll::modules.payroll.incrementMonthlyGrossSalary')" fieldId="netSalary"/>
...
<script>
    ...
    $("#amount").on("keyup change", function () {
        ...
        var newMonthlyGross = number_format((monthlyGross + monthlyIncrement).toFixed(2));
        var newMonthlyIncrement = number_format(monthlyIncrement.toFixed(2));
        var newAnnualGross = number_format((annualGross + grossSalary).toFixed(2));
